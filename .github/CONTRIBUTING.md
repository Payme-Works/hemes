...
Here we have a set of instructions and guidelines to reduce misunderstandings and make the process of contributing to `hemes` as smooth as possible.
...
As a user of `hemes`, you're the perfect candidate to help us improve our documentation!
...
The [`question`](https://github.com/PaymeTrade/hemes/labels/type%3A%20question%20or%20discussion)
and
[`rfc`](https://github.com/PaymeTrade/hemes/labels/type%3A%20rfc)
...
- [`bug` issues](https://github.com/PaymeTrade/hemes/labels/kind%3A%20bug)
  are known bugs we'd like to fix;
- [`enhancement` issues](https://github.com/PaymeTrade/hemes/labels/type%3A%20feature%20request)
  are features we're open to include.

The
[`help wanted`](https://github.com/PaymeTrade/hemes/labels/help%20wanted)
and
[`good first issue`](https://github.com/PaymeTrade/hemes/labels/good%20first%20issue)
